...
form.addEventListener("submit", e => {
    ...
    .catch(err => {
        switch(err) {
            ...
            case 404:
                document.getElementsByClassName('login__form__group__error')[0].style.color = 'red';
...
validateRegistration = () => {
    ...
    if(password != repassword) {
        document.getElementsByClassName('login__form__group__error')[1].style.color = 'red';
